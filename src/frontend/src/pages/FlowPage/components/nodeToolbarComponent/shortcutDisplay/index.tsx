    ...
    <>
      {sidebar ? (
        <div className="flex justify-center">
          ...
          <span
            className={cn(
              "flex h-[16px] w-[16px] items-center justify-center bg-muted text-muted-foreground",
              display_name && "ml-3",
            )}
          >
        ...
        <div className="flex content-center items-center justify-center self-center text-[12px]">
          ...
          <span
            className={`ml-3 flex items-center bg-silver-hover px-1.5 py-[0.1em] text-muted`}
          >
            <RenderIcons filteredShortcut={fixedShortcut} />
          </span>
        </div>
